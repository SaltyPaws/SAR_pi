...
DlgDef::DlgDef( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	//m_bitmap21 = new wxBitmap( _img_exp_sq );
	//const wxBitmap rA = _img_exp_sq;
	//m_bitmap21 = new wxStaticBitmap( m_panel1, wxID_ANY, _img_oil_rig, wxDefaultPosition, wxDefaultSize, 0 );
	//m_bitmap21 = new wxStaticBitmap( _img_exp_sq );
	//m_bitmap21 = new wxStaticBitmap(m_panel1, wxID_ANY,  _img_exp_sq);
...
*/
	//wxStaticBitmap::wxStaticBitmap(wxPanel*&, <anonymous enum>, wxBitmap*&, const wxPoint&, const wxSize&, int)’
    //wxStaticBitmap::wxStaticBitmap(wxWindow*, wxWindowID, const wxBitmap&, const wxPoint&, const wxSize&, long int, const wxString&)-- Candidates are
