...
DlgDef::DlgDef( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxDialog( parent, id, title, pos, size, style )
{
	...
	m_staticText3331 = new wxStaticText( m_panel11, wxID_ANY, _("00b0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText33311 = new wxStaticText( m_panel11, wxID_ANY, _("00b0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_staticText33313 = new wxStaticText( m_panel15, wxID_ANY, _("00b0"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	...
	m_staticText333112 = new wxStaticText( m_panel15, wxID_ANY, _("00b0"), wxDefaultPosition, wxDefaultSize, 0 );
	...
	m_wxNotebook234->AddPage( m_panel15, _("00b0 ' \""), false );
